...
export const ChatMessages = ({
  ...
  setEditingMessageId,
  status
}: ReturnType<typeof useChat> & { chatId: string }) => {
  return (
              ...
              >
                {message.role === "assistant" && (
                  <>
                    ...
                    <BranchOff chatId={chatId} messageIndex={messageIndex} />
                    <RetryMessage retryMessage={retryMessage} messageIndex={messageIndex} />
                    <Share chatId={chatId} messageId={message.id} messageIndex={messageIndex} />
